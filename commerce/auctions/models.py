...
class Bid(models.Model):
    ...
    product = models.ForeignKey(
        Product, on_delete=models.CASCADE, related_name="listing")
...
class Username(models.Model):
    ...
    product = models.ForeignKey(
        Product, on_delete=models.CASCADE, related_name="users")
...
class Watchlist(models.Model):
    product = models.ForeignKey(
        Product, on_delete=models.CASCADE, related_name="list")
    username = models.ForeignKey(
        Username, on_delete=models.CASCADE, related_name="watch")
